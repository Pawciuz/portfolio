...
const technologies: LinkItem[] = [
    ...
    { name: 'shadcn/ui', url: 'https://ui.shadcn.com/', icon: 'https://ui.shadcn.com/apple-touch-icon.png' },
    {
        name: 'Aceternity UI',
...
const tools: LinkItem[] = [
    ...
    { name: 'Zed', url: 'https://zed.dev/', icon: 'https://zed.dev/_next/static/media/zed-logo.11b2d662.png' },
    {
        name: 'PyCharm',
    ...
    },
    {
        ...
        icon: 'https://cdn.icon-icons.com/icons2/1156/PNG/512/1486565573-microsoft-office_81557.png',
    },
    {
        name: 'Visual Studio',
    ...
    },
    {
        ...
        icon: 'https://static-00.iconduck.com/assets.00/brand-github-copilot-icon-512x443-uynt7dzf.png',
    },
    { name: 'Claude', url: 'https://claude.ai', icon: 'https://claude.ai/images/claude_app_icon.png' },
];
