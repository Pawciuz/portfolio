...
<template>
    ...
    >
        ...
        <div class="fade-in" style="animation-delay: 0.3s">
            <h1 class="mb-2 text-3xl font-bold text-blue-900">Paweł Podgórski</h1>
            <h3 class="mb-4 text-xl font-semibold text-blue-700">Front-End Developer</h3>
            <p class="mb-6 text-gray-700">
                Hello! I'm Paweł Podgórski, a passionate Front-End Developer with experience in creating dynamic and
        ...
        <div class="fade-in" style="animation-delay: 0.8s">
            ...
            <p class="flex flex-wrap gap-2">
                ...
                <a href="https://www.radix-ui.com/" target="_blank" rel="noreferrer">
                    <img
                        src="https://logowik.com/content/uploads/images/radix-ui3498.logowik.com.webp"
                        alt="Radix UI"
                        width="40"
                        height="40"
                    />
        ...
        <div class="fade-in" style="animation-delay: 0.8s">
            <h2 class="mb-4 text-2xl font-bold text-blue-900">Tools</h2>
            <p class="flex flex-wrap gap-2">
                ...
                <a href="https://zed.dev/" target="_blank" rel="noreferrer">
                    <img
                        src="https://zed.dev/_next/static/media/zed-logo.11b2d662.png"
                        alt="Zed"
                        width="40"
                        height="40"
                    />
                ...
                <a href="https://github.com/features/copilot" target="_blank" rel="noreferrer">
                    <img
                        src="https://static-00.iconduck.com/assets.00/brand-github-copilot-icon-512x443-uynt7dzf.png"
                        alt="GitHub Copilot"
                        width="40"
                        height="40"
                    />
                ...
                <a href="https://claude.ai" target="_blank" rel="noreferrer">
                    <img src="https://claude.ai/images/claude_app_icon.png" alt="Claude" width="40" height="40" />
                </a>
            </p>
        </div>
    </div>
